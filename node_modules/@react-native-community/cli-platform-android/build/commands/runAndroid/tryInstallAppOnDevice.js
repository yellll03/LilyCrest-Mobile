...
function tryInstallAppOnDevice(args, adbPath, device, androidProject, selectedTask) {
  try {
    var _ref, _variantFromSelectedT, _variantFromSelectedT2;
    ...
    const variantFromSelectedTask = (_ref = selectedTask ?? args.mode) === null || _ref === void 0 ? void 0 : _ref.replace('install', '').split(/(?=[A-Z])/);
