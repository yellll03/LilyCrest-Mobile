...
const ENV = {
  FIREBASE_API_KEY: process.env.EXPO_PUBLIC_FIREBASE_API_KEY || 'AIzaSyBsMEkwGFKfxp_0pItM_g5FzzG8g9Sra1o',
  FIREBASE_WEB_API_KEY: process.env.EXPO_PUBLIC_FIREBASE_WEB_API_KEY || 'AIzaSyBsMEkwGFKfxp_0pItM_g5FzzG8g9Sra1o',
  FIREBASE_ANDROID_API_KEY: process.env.EXPO_PUBLIC_FIREBASE_ANDROID_API_KEY || 'AIzaSyBGoiw8OkTUZ3MO1vZJffyAIefu-aEAo-U',
  FIREBASE_AUTH_DOMAIN: process.env.EXPO_PUBLIC_FIREBASE_AUTH_DOMAIN || 'dormitorymanagement-caps-572cf.firebaseapp.com',
  FIREBASE_PROJECT_ID: process.env.EXPO_PUBLIC_FIREBASE_PROJECT_ID || 'dormitorymanagement-caps-572cf',
  FIREBASE_STORAGE_BUCKET: process.env.EXPO_PUBLIC_FIREBASE_STORAGE_BUCKET || 'dormitorymanagement-caps-572cf.firebasestorage.app',
  FIREBASE_MESSAGING_SENDER_ID: process.env.EXPO_PUBLIC_FIREBASE_MESSAGING_SENDER_ID || '784085654130',
  FIREBASE_WEB_APP_ID: process.env.EXPO_PUBLIC_FIREBASE_WEB_APP_ID || '1:784085654130:web:2fc1e42f23f78d665300eb',
  FIREBASE_ANDROID_APP_ID: process.env.EXPO_PUBLIC_FIREBASE_ANDROID_APP_ID || '1:784085654130:android:e84e6d3a1f4dc3965300eb',
  FIREBASE_MEASUREMENT_ID: process.env.EXPO_PUBLIC_FIREBASE_MEASUREMENT_ID || 'G-F8P190WY99',
  GOOGLE_WEB_CLIENT_ID: process.env.EXPO_PUBLIC_GOOGLE_WEB_CLIENT_ID || '784085654130-ue5677aho518t6btjffc26j6sut1akfj.apps.googleusercontent.com',
  GOOGLE_ANDROID_CLIENT_ID: process.env.EXPO_PUBLIC_GOOGLE_ANDROID_CLIENT_ID || '784085654130-ehalij4p6tvofl6dbjhcqktci9qliiqe.apps.googleusercontent.com',
};
