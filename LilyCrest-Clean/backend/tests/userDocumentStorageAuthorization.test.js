...
// Handler-level adversarial tests for the tenant document storage
// authorization P0: POST/GET/DELETE /api/users/documents... must never
// trust a client-supplied storagePath as authorization by itself. Uses the
// same require.cache-seeding technique as announcementHandlerIntegration.test.js
// to exercise the real user.controller.js handlers (which call
// getDb()/admin.storage() internally) against fakes, without a real
// MongoDB/Firebase connection.
